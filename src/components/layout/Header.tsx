...
export function Header() {
  ...
  return (
    <>
      {/* Book Direct Banner */}
      <div className="bg-primary text-primary-foreground text-center text-xs sm:text-sm font-medium" style={{ height: '36px', lineHeight: '36px' }}>
      ...
      <motion.header
        ...
        className={`fixed left-0 right-0 z-50 transition-all duration-300 bg-background/95 backdrop-blur-md shadow-sm py-2`}
        style={{ top: '0' }}
      >
