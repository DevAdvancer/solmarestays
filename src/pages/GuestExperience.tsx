        ...
        {showSanityContent ? (
          ...
          <>
            ...
            <section ref={heroRef} className="relative h-[72vh] min-h-[500px] flex items-center overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 md:bottom-20 md:left-20 w-[calc(100%-3rem)] md:w-[600px] lg:w-[700px] bg-white/25 backdrop-blur-sm p-8 md:p-12 rounded-[2.5rem] border border-white/10">
                <motion.div
